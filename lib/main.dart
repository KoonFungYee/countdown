...
class _MyHomePageState extends State<MyHomePage> {
  ...
  int startTime = DateTime(2020, 5, 16, 23, 46, 00).millisecondsSinceEpoch;
  int time = DateTime(2020, 5, 16, 23, 46, 15).millisecondsSinceEpoch;
  Duration _duration = Duration(seconds: 1000000);

  @override
  void initState() {
    int seconds = ((time - startTime)/1000).floor();
